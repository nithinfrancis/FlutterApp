...
class AppLocalizations {
  ...
  static Map<String, Map<String, String>> _localizedValues = {
    'en': {
      ...
      'alerts': 'Alerts',
      'leaves': 'Leaves',
      'school_circulars': 'School Circulars',
      'downloads': 'Downloads',
      'logout': 'Logout',
      'students': 'Students',
      ...
      'attachement_size_exceed': 'Maximum 2MB is allowed as an attachment',
      ...
      'bus_passed_destination_kid_still_in_bus': 'Bus has passed your assigned destination @t1. Kid is still on the bus.',
      'kid_entered_bus': 'Kid entered bus from %s @ %s',
      'bus_will_reach_your_dropdown_point_soon': 'Bus has reached %s @%s. Will reach your dropdown point soon.',
      'kid_not_enterd_bus_from_stop': 'Kid has not entered the bus from the assigned stop',
      'kid_entered_from_wrong_pickup_point': '"Kid entered bus from a wrong pickup point %s @%s',
      'kid_alighted_from_bus_wrong_destination': 'Kid has alighted the bus at wrong destination %s @%s',
      'kid_reached_school': 'Kid reached school @%s',
      'kid_is_in_location': 'Kid is in l1 @t1',
      'kid_entered_bus_from_school': 'Kid has entered the bus from school @%s',
      'bus_started_from_school_kid_not_entered': 'Bus has started from the school @%s. Kid has not entered the bus.',
      'bus_started_kid_entered': 'Bus has started from the school. Kid has entered bus from l1 @t1',
      'kid_alighted_from_bus': 'Kid has alighted from bus at l1 @t1',
    ...
    'ml': {
      ...
      'attachement_size_exceed': 'ഒരു അറ്റാച്ച്മെൻറിനായി പരമാവധി 2MB അനുവദിച്ചിട്ടുണ്ട്',
      'description': 'വിവരണം',
      'reference': 'റഫറൻസ്',
    ...
    'ar': {
      ...
      'attachement_size_exceed': 'الحد الأقصى المسموح به هو 2 ميغابايت كمرفق',
      'description': 'وصف',
      'reference': 'مرجع',
